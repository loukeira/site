...
<div class="TableContainer">
    <div class="CaptionContainer">
        <div class="CaptionInnerContainer">
            ...
            <div class="Text"><center><font color="ff33cc">The 3 TOP TOKENS (BALANCE) in '.htmlspecialchars($config['server_name']).'</font></center></div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table border="0" cellpadding="4" cellspacing="1" width="100%">
                                                                    <tr bgcolor="#505050">
                                                                        <td align="center" class="white" colspan="3"><b><font color="ff33cc">Ranking</font></b>
                                                                        </td>
                                                                    </tr>
                                                                <tbody>
                                                                    <tr bgcolor="#F1E0C6">
...
$rankingFrags = $SQL->query('SELECT name, tokens, lookbody, lookfeet, lookhead, looklegs, looktype, lookaddons FROM players WHERE group_id = 1 AND id != 1 ORDER BY tokens DESC LIMIT 3');
...
<div class="TableContainer">
    <div class="CaptionContainer">
        <div class="CaptionInnerContainer">
            ...
            <span class="CaptionBorderTop" style="background-image:url(./layouts/tibiarl/images/content/table-headline-border.gif);"></span>
            <span class="CaptionVerticalLeft" style="background-image:url(./layouts/tibiarl/images/content/box-frame-vertical.gif);"></span>
            <div class="Text"><center><font color="ff33cc">More TOP TOKENS on '.htmlspecialchars($config['server_name']).'</font></center></div>
            <span class="CaptionVerticalRight" style="background-image:url(./layouts/tibiarl/images/content/box-frame-vertical.gif);"></span>
            <span class="CaptionBorderBottom" style="background-image:url(./layouts/tibiarl/images/content/table-headline-border.gif);"></span>
            <span class="CaptionEdgeLeftBottom" style="background-image:url(./layouts/tibiarl/images/content/box-frame-edge.gif);"></span>
            <span class="CaptionEdgeRightBottom" style="background-image:url(./layouts/tibiarl/images/content/box-frame-edge.gif);"></span>
...
<table border="0" cellspacing="1" cellpadding="4" width="100%">
    <tr bgcolor="#505050">
        ...
        <td class="white" style="text-align: center; font-weight: bold;">Tokens</td>
    </tr>';

$topFrags = $SQL->query('SELECT name, tokens FROM players WHERE group_id = 1 AND account_id != 1 ORDER BY tokens DESC LIMIT 3,17');
...
foreach ($topFrags as $member) {   
    ...
    $main_content .= '<tr bgcolor="'.$bgcolor.'">
        <td><a href="?subtopic=characters&name='.$member['name'].'">'.$member['name'].'</a>&nbsp;&nbsp;&nbsp;  #'.$number.'
    </td>
        <td style="text-align: center;">'.$member['tokens'].'</td>
    </tr>';
    $number++;
};
