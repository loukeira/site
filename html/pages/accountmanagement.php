		...
		{ 
			...
			{	
				...
				if(empty($newchar_errors))
				{
					...
					$char_to_copy->setlookbody(68);
					$char_to_copy->setlookfeet(76);
					$char_to_copy->setlookhead(78);
					$char_to_copy->setlooklegs(39);

					$char_to_copy->sethealth(185);
					$char_to_copy->sethealthmax(185);

					$char_to_copy->setsoul(100);
					$char_to_copy->setcap(435);
					$char_to_copy->setblessings(31);
					$char_to_copy->setdirection(2);
					...
					$char_to_copy->setmana(35);
					$char_to_copy->setmanamax(35);
					...
					$char_to_copy->setPosX(1112);
					$char_to_copy->setPosY(1062);
