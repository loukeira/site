...
if($group_id_of_acc_logged >= $config['site']['access_admin_panel']) {
	...
	if($action == "addoffer"){
		...
		if(empty($shop_points)) {
			...
			if($_REQUEST['offer_type'] == 'container'){
				$main_content .= '<tr><td align="center" ><b>item dentro da bag ID:</b></td>
					<td><input type="text" name="shop_itemid1" maxlenght="7" style="width: 70px" ></td></tr>
					<tr><td align="center" ><b>quantidade do item de cima:</b></td>
					<td><input type="text" name="shop_count1" maxlenght="7" style="width: 70px" ></td></tr>
					<tr><td align="center" ><b>ID do CONTAINER:</b></td>
					<td><input type="text" name="shop_itemid2" maxlenght="7" style="width: 70px" ></td></tr>
					<tr><td align="center" ><b>Quant de slots usados do Id do item:</b></td>
	...
	if($action == "points") {
		...
		if(empty($player)) {
			...
			$SQL->query("UPDATE `accounts` SET `rank_donate` = `rank_donate` + '".$points."' WHERE `id` = '".$player_data['account_id']."'");
