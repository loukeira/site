						...
						<div class="Border_3">
							...
							$news_content .= '
								...
								<a id="Link" href="'.$featured['read_more'].'"></a>';
                                                                ...
                                                                $news_content .= '
                                                                <div id="TeaserText">
                                                                        <b>IP:</b> BaiakPvp.com</font> - <b>VERSION:</b> 8.60 - <b>PORT:</b> 7171 <b><a href="./downloads/pvp.exe">CLIENTE PR&Oacute;PRIO 8.60</a></b><br>
										                                                                          <br><b>BaiakPvp</b> private Tibia OTServer, <a href="/?subtopic=serverinfo"<b>Server Info</b></a>.<br>
                                                                        Utilizamos <b>Mapa Baiak</b> com todas as Quests configuradas, todos os respawns e NPCS<br>
                                                                        Servidor sem BUG, totalmente perfeito, sem LAG, seguran&ccedil;a total e prote&ccedil;&atilde;o contra DDoS.<br>
                                                                        Tudo que voc&ecirc; precisa pra ter <b>divers&atilde;o garantida</b> voc&ecirc; encontra aqui!<br>
                                                                        Parab&eacute;ns pela sua escolha e tenha certeza que somos atualmente o melhor <b>Baiak</b>.<br>
                                                                </div>        
							</div>
						</div>
					</div>
