...
<table>
<tr><td><input type="hidden" name="on0" value="MegaPoints">MegaPoints</td></tr><tr><td><select name="os0">
	<option value="10 Pontos">10 Pontos R$10,00</option>
	<option value="20 Pontos">20 Pontos R$20,00</option>
	<option value="30 Pontos">30 Pontos R$30,00</option>
	<option value="40 Pontos">40 Pontos R$40,00</option>
	<option value="50 Pontos">50 Pontos R$50,00</option>
	<option value="70 Pontos">70 Pontos R$70,00</option>
	<option value="100 Pontos">100 Pontos R$100,00</option>
	<option value="150 Pontos">150 Pontos R$150,00</option>
	<option value="200 Pontos">200 Pontos R$200,00</option>
	<option value="250 Pontos">250 Pontos R$250,00</option>
</select> </td></tr>
...
<br/>
	...
	<tr>
	<center>
	<td bgcolor="'.$config['site']['darkborder'].'" witdh="2%"><center><img src="./images/bank/cx.png"/>
    </b></left></td>
    </b></center></td>
	</tr>
	<tr>
	...
	<tr>
	<td bgcolor="'.$config['site']['lightborder'].'" witdh="2%"><left>Agencia : 0852</left></td>
	</tr>
	</tr>
	<tr>
	<td bgcolor="'.$config['site']['lightborder'].'" witdh="2%"><left>Conta &nbsp;&nbsp;&nbsp;: 00004741-6</left></td>
	
	</tr>
	</tr>
	<tr>
	<td bgcolor="'.$config['site']['lightborder'].'" witdh="2%"><left>Favorecido : Eliton de Souza</left></td>
	</tr>
	<td bgcolor="'.$config['site']['lightborder'].'" witdh="2%"><left>Operação : 023</left></td>
	...
	<tr>
	<td bgcolor="'.$config['site']['darkborder'].'" witdh="2%"><center><a href="?subtopic=doacao&action=pagseguro"><img src="./images/bank/pgs.png"/></a>
    </center></td>
	</tr>
	<tr>
	</tr>
	...
	<p>Mande um e-mail para <font color="blue">eliton_cnb@hotmail.com</font> com os dados da doacao. 
	...
	Se seu pedido nao chegar em 48 Hrs apos a confirmacao, reenvie o e-mail de confirmacao com o assunto "Atraso" para <font color="blue">eliton_cnb@hotmail.com</font> e aguarde a liberacao dos seus points!! Bom Jogo!! 
