...
<script>(function(d, s, id) {
  ...
  <div id="submenu_latestnews" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
							...
							<a href="?subtopic=latestnews">
								...
								<a href="?subtopic=shopoff">
  								<div id="submenu_shopoff" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
									...
									<div id="ActiveSubmenuItemLabel_shopoff" class="SubmenuitemLabel"><span style="color:#d7d7d7;"><img src="/images/shop/shopp.png" height="14" width="14"><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)"> Shop Offline <small><font color="#3ea7fa">[new]</font></small></span></span></div>
									<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
  								</div>
								</a>
            ...
            <!--TOken-->
            <a href="?subtopic=toptokens">
            <div id="submenu_fraggers" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
              <div class="LeftChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
              <div id="ActiveSubmenuItemIcon_fraggers" class="ActiveSubmenuItemIcon" style="background-image:url(<?PHP echo $layout_name; ?>/images/menu/icon-activesubmenu.gif);"></div>
              <div id="ActiveSubmenuItemLabel_fraggers" class="SubmenuitemLabel"><span style="color:#d7d7d7;">Top Tokens</span></span></div>
              <div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
            </div>
          </a>
      <!--TOP DNT-->
             <a href="?subtopic=topdonates">
            <div id="submenu_fraggers" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
              <div class="LeftChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
              <div id="ActiveSubmenuItemIcon_fraggers" class="ActiveSubmenuItemIcon" style="background-image:url(<?PHP echo $layout_name; ?>/images/menu/icon-activesubmenu.gif);"></div>
              <div id="ActiveSubmenuItemLabel_fraggers" class="SubmenuitemLabel"><span style="color:#d7d7d7;">Top Donates</span></span></div>
              <div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
            </div>
          </a>
                <!--TOP BALANCE-->
             <a href="?subtopic=topbalance">
            <div id="submenu_fraggers" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
              <div class="LeftChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
              <div id="ActiveSubmenuItemIcon_fraggers" class="ActiveSubmenuItemIcon" style="background-image:url(<?PHP echo $layout_name; ?>/images/menu/icon-activesubmenu.gif);"></div>
              <div id="ActiveSubmenuItemLabel_fraggers" class="SubmenuitemLabel"><span style="color:#d7d7d7;">Top Balance</span></span></div>
              <div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
            </div>
          </a>
			...
			<div id="community_Submenu" class="Submenu">
				...
				<a href="?subtopic=promotion">
					<div id="submenu_promotion" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_promotion" class="SubmenuitemLabel"><span style="color:#d7d7d7;"><img src="" alt=""><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">New Promotion <small><font color="#3ea7fa">[new]</font></small></span></span></div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
				<a href="?subtopic=addonbonus">
					<div id="submenu_addonbonus" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_addonbonus" class="SubmenuitemLabel"><span style="color:#d7d7d7;"><img src="" alt=""><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">Addon Bonus <small><font color="#3ea7fa">[new]</font></small></span></span></div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
			...
			<a href="?subtopic=teambattle">
				...
				<a href="?subtopic=snowballwar">
					<div id="submenu_snowballwar" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_snowballwar" class="SubmenuitemLabel"><span style="color:#d7d7d7;"><img src="" alt=""><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">Snow Ball War <img src="layouts/tibiarl/images/general/neve.png" height="14" width="14"></span></span></div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
			...
			<a href="?subtopic=warofemperium">
					<div id="submenu_warofemperium" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_warfoemperium" class="SubmenuitemLabel"><span style="color:#d7d7d7;">Castle 48H <img src="layouts/tibiarl/images/general/castelo.gif" height="14" width="14"> </div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
			...
			<a href="?subtopic=castle24hr">
					<div id="submenu_castle24hr" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_castle24hr" class="SubmenuitemLabel"><span style="color:#d7d7d7;">Castle 24H <img src="layouts/tibiarl/images/general/castle.png" height="14" width="14"> </div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
			...
			<a href="?subtopic=loteria">
					<div id="submenu_loteria" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_loteria" class="SubmenuitemLabel"><span style="color:#d7d7d7;">Loteria VIP <img src="layouts/tibiarl/images/general/lote.gif" height="14" width="25"></span></span></div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
			...
			<a href='?subtopic=confirmacao'>
				...
				<a href='?subtopic=shopguild'>
  					<div id='submenu_shopguild' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)'>
						...
						<div class="SubmenuitemLabel"><blink style="color: #18ff00; background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">Shop Guild</blink></div>
						<div class='RightChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
  					</div>
				</a>
				<?PHP
  ...
  <div class="top_level" style="background:url(<?PHP echo $layout_name; ?>/images/bg_top.png)" align="	">
	...
	foreach($skills as $skill) {
	  ...
	  <a href="?subtopic=characters&name='.$skill['name'].'" class="topfont">
	   ...
	   <img src="/images/animated/animoutfit.php?id='.$skill['looktype'].'&addons='.$skill['lookaddons'].'&head='.$skill['lookhead'].'&body='.$skill['lookbody'].'&legs='.$skill['looklegs'].'&feet='.$skill['lookfeet'].'" width="64" height="64" style="width: 64px; height: 64px; position: absolute; background-position: 0 0; background-repeat: no-repeat; left: -50px; margin-top: -70px;">
